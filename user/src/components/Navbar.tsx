      ...
      <div id="nav-container" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20 gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3.5">
            <a
              href="/admin"
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-emerald-700 bg-emerald-50 border border-emerald-200 hover:bg-emerald-100 dark:bg-emerald-950/50 dark:border-emerald-800/60 dark:text-emerald-300 dark:hover:bg-emerald-900/60 rounded-lg transition-colors cursor-pointer"
              title="Open Separate Admin Portal"
            >
              <Terminal className="w-4 h-4 text-emerald-500" />
              <span className="hidden sm:inline font-mono">Admin Portal</span>
              <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-mono">/admin</span>
            </a>
            <button
